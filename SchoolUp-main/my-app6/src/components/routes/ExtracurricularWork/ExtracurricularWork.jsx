...
import {TopPanelUniversity, LeftPanelOfExtracurricularWork} from "../../ui/NavigationPanels/NavigationPanels.jsx";
import {EvProf} from "../../../See.js";

function ExtracurricularWorkPage() {
	window.onload = function() {
            document.getElementById('extracurricularWork').className = "topbutton-page-university";
	...
	return (
		<div className="pageUniversity">
			...
			<div className="mavr">
					<div id="LeftPanelVR">
						<LeftPanelOfExtracurricularWork/>
					</div>
...
export default ExtracurricularWorkPage;